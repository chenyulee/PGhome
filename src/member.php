<?php 
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if($_POST['password']!=$_POST['password_check']){
            ...
            if(mysqli_fetch_array($result)!== false){$error_name = '已有相同帳號';}
            else{
...
<html>
    ...
    <body>
        ...
        <form action="member.php" method="post" align="center">
            <p><font size=+3>註冊會員</font></p>
            帳號:<input type="text" name="name" value="<?php if(isset($_POST['name'])){echo $_POST['name'];}?>" ><br>
            ...
            ?></div>
            性別:<input type="radio"" name="gender" value="male" <?php if(isset($_POST['gender']) && $_POST['gender'] == 'male'){ echo 'checked';}?>> 男
                 <input type="radio"" name="gender" value="female"<?php if(isset($_POST['gender']) && $_POST['gender'] == 'female'){ echo 'checked';}?>> 女<br>
